...
const ChatWithAI = () => {
  ...
  if (!user?.verified) {
    return (
      <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-br from-red-50 via-pink-50 to-purple-50 dark:from-gray-950 dark:via-red-950 dark:to-purple-950 px-4">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-3xl p-10 shadow-2xl max-w-md text-center relative overflow-hidden border border-white/20"
        >
          <div className="absolute -top-20 -left-20 w-40 h-40 bg-gradient-to-br from-pink-400 to-red-500 rounded-full opacity-20 blur-3xl"></div>
          <div className="absolute -bottom-20 -right-20 w-40 h-40 bg-gradient-to-br from-red-500 to-pink-400 rounded-full opacity-20 blur-3xl"></div>

          <motion.div
            animate={{ scale: [1, 1.1, 1] }}
            transition={{ duration: 2, repeat: Infinity }}
            className="w-20 h-20 bg-gradient-to-br from-red-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg"
          >
            <svg
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8 text-sm sm:text-base">
            ...
            <strong>Smart Notes</strong>. Please go to your{" "}
            <strong>Profile Page</strong> and complete the verification process.
          </p>
          ...
          <div className="flex justify-center gap-4">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-2xl font-semibold shadow-lg"
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-6 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-800 dark:text-gray-200 rounded-2xl font-semibold shadow-lg"
